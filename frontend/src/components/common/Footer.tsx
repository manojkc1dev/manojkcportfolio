...
import { Terminal, Send, CheckCircle2, Download } from "lucide-react";

export const Footer: React.FC = () => {
  const { hero, socials, addNewsletterSubscriber, setIsResumeModalOpen } =
    useCMS();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs text-slate-500 dark:text-slate-400">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
            <div>
              © {new Date().getFullYear()} {hero?.name || "Portfolio"}. All
              rights reserved.
            </div>
